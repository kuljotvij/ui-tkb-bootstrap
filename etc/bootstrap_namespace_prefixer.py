...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        ...
        bsTopDir = sys.argv[1]
        cssClassNames = None
        for cssFile in ('sl-bootstrap.css', 'sl-bootstrap.min.css', 'sl-bootstrap-responsive.css', 'sl-bootstrap-responsive.min.css'):
        ...
        if cssClassNames != None:
            ...
            for jsFile in ('sl-bootstrap.js', 'sl-bootstrap.min.js'):
